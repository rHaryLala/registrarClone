...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
    ...
    <div class="main-content min-h-screen">
        ...
        <?php if(isset($lastChangedBy) && $lastChangedBy): ?>
            <?php
                $lcName = '-';
            ...
            <div id="last-change-toast" class="fixed top-4 right-4 z-50 bg-white border border-gray-200 shadow-lg rounded-lg px-4 py-3 flex items-start gap-3" role="status" aria-live="polite">
                ...
                <div>
                    ...
                    <div class="text-sm text-gray-600">Par <?php echo e($lcName); ?><?php if($lcWhen): ?> • <?php echo e($lcWhen); ?><?php endif; ?></div>
                </div>
        ...
        <main class="p-6 max-w-7xl mx-auto">
            ...
            <div class="hidden lg:block bg-white rounded-2xl shadow-xl overflow-hidden slide-up">
                <div class="overflow-x-auto">
                    <table class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-100" id="financeTableBody">
                            <?php $__currentLoopData = $finances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $finance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="table-row finance-row stagger-<?php echo e(($index % 4) + 1); ?>" 
                                data-student="<?php echo e(strtolower($finance->student->prenom ?? '')); ?> <?php echo e(strtolower($finance->student->nom ?? '')); ?>"
                                data-type="<?php echo e(strtolower($finance->plan ?? '')); ?>"
                                data-status="<?php echo e(strtolower(($finance->total_payment ?? '0') != '0' ? 'payé' : 'en_attente')); ?>">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-semibold mr-3">
                                            <?php echo e(substr($finance->student->prenom ?? 'U', 0, 1)); ?><?php echo e(substr($finance->student->nom ?? 'N', 0, 1)); ?>

                                        </div>
                                        <div>
                                            <div class="font-semibold text-gray-900"><?php echo e($finance->student->prenom ?? ''); ?> <?php echo e($finance->student->nom ?? ''); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-600"><?php echo e($finance->student->matricule ?? '-'); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 plan-cell" data-finance-id="<?php echo e($finance->id); ?>" title="Double-cliquer pour modifier">
                                        <?php echo e($finance->plan ?? '-'); ?>
                ...
                <?php if($studentForPlan): ?>
                    <div class="bg-white rounded-2xl shadow-md p-6 mt-6">

                        
                        <input type="hidden" id="montant-sans-frais" value="<?php echo e($Montant_sans_frais_Generaux); ?>">
                        
                        <input type="hidden" id="montant-tranche-base" value="<?php echo e($Montant_tranche_base); ?>">
                                ...
                                <table class="w-full text-sm text-gray-700 details-table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->frais_generaux ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Dortoir</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->dortoir ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Cantine</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->cantine ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Labo info</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->labo_info ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Labo comm</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->labo_comm ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Labo langue</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->labo_langue ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Ecolage</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->ecolage ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Voyage d'étude</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->voyage_etude ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Colloque</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->colloque ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">Frais costume</td>
                                            <td class="py-2 text-right font-medium"><?php echo e(number_format($computed->frais_costume ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                        <tr class="border-t mt-2">
                                            <td class="py-3 font-semibold">Total</td>
                                            <td class="py-3 text-right font-semibold"><?php echo e(number_format($computed->total_amount ?? $computed->total_due ?? 0, 0, ',', ' ')); ?> ar</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="w-full lg:w-1/2">
                                <div class="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                                    <div class="mb-3 flex items-center justify-between">
                                        <div>
                                            <h4 id="planHeader" class="font-semibold text-lg">Plan de paiement — TYPE <?php echo e($modeP); ?></h4>
                                            <div id="planAmount" class="text-sm text-gray-500">Montant: <?php echo e(number_format($Montant_tranche_base, 0, ',', ' ')); ?> ar</div>
                                        </div>
                                    </div>
                                ...
                                <?php if($modeP === 'A'): ?>
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 text-right pr-6"><?php echo e(number_format($Montant_tranche_base, 0, ',', ' ')); ?> ar</td>
                                        <td class="px-3 py-2 pl-6"><span class="date-text text-sm text-gray-700">3 octobre 2025</span></td>
                                    </tr>
                                <?php elseif($modeP === 'B'): ?>
                                    <tr>
                                        <td class="px-3 py-2">50 %</td>
                                        <td class="px-3 py-2 text-right pr-6"><?php echo e(number_format(($Montant_tranche_base * 50) / 100, 0, ',', ' ')); ?> ar</td>
                                        <td class="px-3 py-2 pl-6"><span class="date-text text-sm text-gray-700">3 octobre 2025</span></td>
                                    </tr>
                                    <tr>
                                        <td class="px-3 py-2">50 %</td>
                                ...
                                <?php elseif($modeP === 'C'): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 text-right pr-6"><?php echo e(number_format(($Montant_tranche_base * 25) / 100, 0, ',', ' ')); ?> ar</td>
                                ...
                                <?php elseif($modeP === 'D'): ?>
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 text-right pr-6"><?php echo e(number_format(($Montant_tranche_base * 75) / 100, 0, ',', ' ')); ?> ar</td>
                                        <td class="px-3 py-2 pl-6"><span class="date-text text-sm text-gray-700">3 octobre 2025</span></td>
                                    </tr>
                                    <tr>
                                        <td class="px-3 py-2">25 %</td>
                                ...
                                <?php elseif($modeP === 'E'): ?>
                                    ...
                                    <tr>
                                        <td class="px-3 py-2">25 %</td>
                                        <td class="px-3 py-2 text-right pr-6"><?php echo e(number_format(($Montant_sans_frais_Generaux * 25) / 100, 0, ',', ' ')); ?> ar</td>
                                        <td class="px-3 py-2 pl-6"><span class="date-text text-sm text-gray-700">19 décembre 2025</span></td>
                                    </tr>
                                    <tr>
                                        <td class="px-3 py-2">25 %</td>
    ...
    <script>
        ...
        function makePlanEditable(el) {
            ...
            const finish = (save) => {
                if (save) {
                    fetch(`<?php echo e(url('/chief-accountant/finances')); ?>/${financeId}/plan`, {
                        method: 'PATCH',
                        headers: {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            try {
                ...
                const serverMode = '<?php echo e($modeP ?? 'A'); ?>';
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/chief_accountant/finances/list.blade.php ENDPATH**/ ?>