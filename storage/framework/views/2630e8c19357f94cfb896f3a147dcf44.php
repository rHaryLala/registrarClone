            ...
            <div class="stats-card bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:border-green-200">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <h3 class="number-counter text-2xl font-bold text-gray-800"><?php echo e($studentsCount); ?></h3>
                    </div>
                </div>
                <!-- Statistiques dynamiques à implémenter -->
            </div>
...
</html><?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/superadmin/dashboard.blade.php ENDPATH**/ ?>