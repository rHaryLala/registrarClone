                ...
                <div style="background:linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border:2px solid #bae6fd; border-radius:12px; padding:16px; margin-bottom:24px;">
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <div style="display:flex; gap:12px; flex-wrap:wrap;">
                            ...
                            <label style="display:flex; align-items:center; gap:8px; font-size:13px; color:#374151;">
                                <input type="checkbox" name="export_attendance" value="1" style="width:16px; height:16px;">
                                Exporter la fiche de présence
                            </label>
                            <label style="display:flex; align-items:center; gap:8px; font-size:13px; color:#374151;">
                                <input type="checkbox" name="export_week_attendance" value="1" style="width:16px; height:16px;">
                                Exporter fiche semaine (Lun–Jeu)
                            </label>
                        </div>
                    </div>
