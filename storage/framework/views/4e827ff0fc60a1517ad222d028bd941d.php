    ...
    <div class="main-content min-h-screen">
        ...
        <main class="p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('superadmin.teachers.create')); ?>" class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800 transition flex items-center">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($teacher->name); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($teacher->email); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($teacher->telephone); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($teacher->diplome); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap flex space-x-2">
                                    <a href="<?php echo e(route('superadmin.teachers.edit', $teacher->id)); ?>" class="text-blue-600 hover:underline flex items-center">
                                        <i class="fas fa-edit mr-1"></i> Modifier
                                    </a>
                                    <form action="<?php echo e(route('superadmin.teachers.destroy', $teacher->id)); ?>" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet enseignant ?');">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/superadmin/teachers/list.blade.php ENDPATH**/ ?>