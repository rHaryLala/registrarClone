...
<body class="bg-gray-50 font-montserrat min-h-screen">
    ...
    <main class="max-w-4xl mx-auto px-4 py-8">
        ...
        <!-- Form -->
        <form id="inscription-form" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6" method="POST" action="<?php echo e(route('register.store')); ?>">
            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" id="bacc_date_obtention" name="bacc_date_obtention"
                                        min="2010" max="<?php echo e(date('Y')+1); ?>"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent"
                                        placeholder="Ex: 2025">
                                </div>
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/register.blade.php ENDPATH**/ ?>