        ...
        <main class="px-6 pb-12">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="glass-card rounded-2xl p-8 fade-in fade-in-delay-1">
                    <form action="<?php echo e(route('superadmin.students.courses.store', $student->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/superadmin/students/courses-add.blade.php ENDPATH**/ ?>