...
<head>
    <meta charset="UTF-8">
    <title>Fiche d'inscription - <?php echo e($student->prenom); ?> <?php echo e($student->nom); ?></title>
...
<div class="col-lg-8">
    <div class="head">
        <center>
            <div>
                <h2>Fiche d'inscription <?php echo e($student->created_at->format('Y')); ?> - <?php echo e($student->created_at->format('Y')+1); ?> <br>Premier semestre</h2>
            </div>
        </center>
    </div>
    <div class="inline">
                        ...
                        <table style="width:100%; border-collapse: collapse;">
                            <tr>
                                <td style="width:40%; vertical-align:top; padding-right:8px;">
                                    <div style="margin-bottom:4px;"><b>Matricule :</b> <?php echo e($student->matricule); ?></div>
                                    <div style="margin-bottom:4px;"><b>N° de compte :</b> <?php echo e($student->account_code); ?></div>
                                    <div style="margin-bottom:4px;"><b>Nom :</b> <?php echo e($student->nom); ?> <?php echo e($student->prenom); ?></div>
                                    <div style="margin-bottom:4px;"><b>Mention :</b> <?php echo e($student->mention ? $student->mention->nom : '-'); ?></div>
                                    <div style="margin-bottom:4px;"><b>Parcours :</b> <?php echo e($student->parcours ? $student->parcours->nom : '-'); ?></div>
                                    <div style="margin-bottom:4px;"><b>Niveau d'étude :</b> <?php echo e($student->yearLevel ? $student->yearLevel->label : ($student->annee_etude ?? '-')); ?></div>
                                </td>
                                <td style="width:60%; vertical-align:top;">
                                    <div style="margin-bottom:4px;"><b>Email / Tél:</b> <?php echo e($student->email); ?> / <?php echo e($student->telephone); ?></div>
                                    <div style="margin-bottom:4px;"><b>Adresse :</b> <?php echo e($student->adresse); ?></div>
                                    <div><b>Résidence :</b> <?php echo e($student->statut_interne); ?></div>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <div style="min-height: 300px;">
            ...
            <div class="informationbox col-lg-12" style="border-radius: 0px;">
                <table class="tbl">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $takenCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $codes = $course->yearLevels->pluck('code')->map(function($c){ return strtoupper($c); })->filter()->values()->toArray();
                                $isOnlyL1R = (count($codes) > 0 && collect($codes)->unique()->count() === 1 && strtoupper($codes[0]) === 'L1R');
                            ?>
                            <tr>
                                <td><?php echo e($course->sigle); ?></td>
                                <td><?php echo e($course->nom); ?></td>
                                <td>
                                    <?php if($isOnlyL1R): ?>
                                        -
                                    <?php else: ?>
                                ...
                                <td>
                                    <?php echo e(number_format($course->credits * 19000, 0, ',', ' ')); ?> Ar
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="marck">Cours : <?php echo e($takenCourses->count()); ?></td>
                            <td></td>
                            <td class="marck"><?php echo e($totalCredits); ?></td>
                            <td></td>
                            <td></td>
                        </tr>
                    </tbody>
                ...
                <div style="display:flex; gap:24px;">
                        ...
                        <table class="tbl">
                            <thead>
                                <tr>
                                    ...
                                    <?php if(isset($student->statut_interne) && $student->statut_interne): ?>
                                        <th>Dortoir</th>
                                    <?php endif; ?>
                                    <?php if(isset($student->abonne_caf) && $student->abonne_caf): ?>
                                        <th>Cantine</th>
                                    <?php endif; ?>
                                    <th>Sous-total</th>
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo e(number_format($fraisGeneraux ?? 0, 0, ',', ' ')); ?> Ar</td>
                                    <td><?php echo e(number_format($coutCredit ?? 0, 0, ',', ' ')); ?> Ar</td>
                                    <td><?php echo e(number_format($labo_info ?? 0, 0, ',', ' ')); ?> Ar</td>
                                    <?php if(isset($student->statut_interne) && $student->statut_interne): ?>
                                        <td><?php echo e(number_format($coutDortoir ?? 0, 0, ',', ' ')); ?> Ar</td>
                                    <?php endif; ?>
                                    <?php if(isset($student->abonne_caf) && $student->abonne_caf): ?>
                                        <td><?php echo e(number_format($coutCantine ?? 0, 0, ',', ' ')); ?> Ar</td>
                                    <?php endif; ?>
                                    <td><strong><span><?php echo e(number_format($subtotal1, 0, ',', ' ')); ?> Ar</span></strong></td>
                                    <td style="text-align:center;"><strong><span><?php echo e($modeP ?? 'A'); ?></span></strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div style="flex:1; padding:6px;">
                        <table class="tbl">
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo e(number_format($voyage_or_colloque ?? 0, 0, ',', ' ')); ?> Ar</td>
                                            <?php if($showCostume): ?>
                                                <td><?php echo e(number_format($costume ?? 0, 0, ',', ' ')); ?> Ar</td>
                                            <?php endif; ?>
                                    <td><strong><span><?php echo e(number_format($subtotal2, 0, ',', ' ')); ?> Ar</span></strong></td>
            ...
            <div style="text-align:left; font-size:15px; font-weight:bold; margin-bottom:10px;">
                Montant total : <?php echo e(number_format($totalFinance, 0, ',', ' ')); ?> Ar <span style="font-style: italic; font-size: 10px;">(à payer lors de l'inscription : <?php echo e(number_format($fraisGeneraux, 0, ',', ' ')); ?> Ar)</span>
            </div>
            ...
            <tr>
                ...
                <div style="width:100%;">
                    <?php if(!empty($student->bursary_status) && ($student->bursary_status == 1 || $student->bursary_status === true)): ?>
                            <p style="margin:0 0 8px 0; font-size:3em; line-height:1;"><strong>Boursier par <?php echo e(trim(($student->sponsor_nom ?? '') . ' ' . ($student->sponsor_prenom ?? '')) ?: '—'); ?></strong></p>
                    <?php else: ?>
                        ...
                        <table class="tbl mb-2 payment-table">
                            <thead>
                                ...
                                <tr>
                                    <th colspan="3" class="text-center text-bold">À payer en tranches de TYPE <?php echo e($modeP); ?> : <?php echo e(number_format($Montant_sans_frais_Generaux, 0, ',', ' ')); ?> ar </th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if($modeP === 'A'): ?>
                                    <tr>
                                        <td>100 %</td>
                                        <td class="text-right"><?php echo e(number_format($Montant_sans_frais_Generaux, 0, ',', ' ')); ?> ar</td>
                                        <td><input type="text" class="date-input" value="3-oct.-25"></td>
                                    </tr>
                                <?php elseif($modeP === 'B'): ?>
                                    <tr>
                                        <td>50 %</td>
                                        <td class="text-right"><?php echo e(number_format(($Montant_sans_frais_Generaux * 50) / 100, 0, ',', ' ')); ?> ar</td>
                                        <td><input type="text" class="date-input" value="3-oct.-25"></td>
                                    </tr>
                                    <tr>
                                        <td>50 %</td>
                                ...
                                <?php elseif($modeP === 'C'): ?>
                                    ...
                                    <tr>
                                        <td>25 %</td>
                                        <td class="text-right"><?php echo e(number_format(($Montant_sans_frais_Generaux * 25) / 100, 0, ',', ' ')); ?> ar</td>
                                ...
                                <?php elseif($modeP === 'D'): ?>
                                    <tr>
                                        <td>75 %</td>
                                        <td class="text-right"><?php echo e(number_format(($Montant_sans_frais_Generaux * 75) / 100, 0, ',', ' ')); ?> ar</td>
                                        <td><input type="text" class="date-input" value="3-oct.-25"></td>
                                    </tr>
                                    <tr>
                                        <td>25 %</td>
                ...
                <h4>ENGAGEMENT</h4>
                <b>Je sousigné(e), <?php echo e($student->nom); ?> <?php echo e($student->prenom); ?>,</b>
        ...
        <div>
            <p>Sambaina, le <?php echo e(\Carbon\Carbon::now()->locale('fr')->isoFormat('D MMMM YYYY')); ?></p>
        </div>
        <p>Approuvée par :</p>
        <p></p>
        ...
        <div style="border-top:1px solid black; width: 100%;">
            <table class="tbl">
                <tr>
                    ...
                    <td><em>
                        - ref: <?php echo e(now()->year); ?><?php echo e($student->account_code); ?> -
                    </em></td>
                </tr>
            </table>
        </div>
...
</html><?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/PDFexport/recap-pdf.blade.php ENDPATH**/ ?>