            ...
            <div class="bg-gradient-to-r from-blue-800 via-blue-700 to-blue-600 rounded-xl shadow-2xl p-8 mb-8 relative overflow-hidden animate-fade-in">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 relative z-10">
                    ...
                    <div class="animate-slide-in-right flex items-center gap-3">
                        <a href="<?php echo e(route('superadmin.students.courses.add', $student->id)); ?>" 
                        ...
                        <a href="<?php echo e(route('superadmin.students.show', $student->id)); ?>" 
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $student->courses()->withPivot('added_at', 'created_at', 'deleted_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-blue-50/50 transition-all duration-300 transform hover:scale-[1.01] animate-fade-in-row <?php if($course->pivot->deleted_at): ?> bg-red-50/80 <?php endif; ?>" 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if(!$course->pivot->deleted_at): ?>
                                            <form action="<?php echo e(route('superadmin.students.courses.remove', [$student->id, $course->id])); ?>" method="POST" 
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/superadmin/students/courses-history.blade.php ENDPATH**/ ?>