...
<body class="bg-white text-gray-600 font-opensans h-full flex flex-col">
    ...
    <main class="flex-grow">
        ...
        <section class="animate-on-load animate-fade-in-up delay-200">
            <?php echo $__env->make('layouts.welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </section>
...
</html><?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/welcome.blade.php ENDPATH**/ ?>