...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
                            ...
                            <div class="w-full lg:w-1/2">
                                <div class="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                                    <div class="mb-3 flex items-center justify-between">
                                        <div>
                                            <h4 class="font-semibold text-lg">Plan de paiement — TYPE <?php echo e($modeP); ?></h4>
                                            <div class="text-sm text-gray-500">Montant: <?php echo e(number_format($Montant_tranche_base, 0, ',', ' ')); ?> ar</div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function makePlanEditable(el) {
            ...
            const finish = (save) => {
                if (save) {
                    fetch(`<?php echo e(url('/superadmin/finances')); ?>/${financeId}/plan`, {
                        method: 'PATCH',
                        headers: {
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/superadmin/finances/list.blade.php ENDPATH**/ ?>