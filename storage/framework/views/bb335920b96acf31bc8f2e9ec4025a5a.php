    ...
    <div class="main-content min-h-screen">
        ...
        <main class="p-8 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
                ...
                <a href="<?php echo e(route('superadmin.mentions.create')); ?>" 
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $mentions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="cursor-pointer hover:bg-blue-50 transition-all duration-200 group" 
                                    onclick="window.location='<?php echo e(route('superadmin.mentions.show', $mention->id)); ?>'">
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900"><?php echo e($mention->nom); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-5">
                                        <div class="text-sm text-gray-700 max-w-xs truncate"><?php echo e($mention->description); ?></div>
                                    </td>
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        <div class="flex space-x-3">
                                            <a href="<?php echo e(route('superadmin.mentions.edit', $mention->id)); ?>" 
                                            ...
                                            <form action="<?php echo e(route('superadmin.mentions.destroy', $mention->id)); ?>" method="POST" 
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/superadmin/mentions/list.blade.php ENDPATH**/ ?>