...
<table style="width: 100%; color: #000; border-bottom: 1px solid #8e9bb2;">
    <tr>
        <td style="width:20%; vertical-align: middle; padding:8px 12px;">
            <?php if($logoBase64): ?>
                <img src="<?php echo e($logoBase64); ?>" style="height:80px; display:block;">
            <?php endif; ?>
        </td>
...
<?php if(!empty($logoBase64)): ?>
    <div style="position: fixed; top:40%; left:50%; transform: translate(-50%, -50%); width:70%; opacity:0.06; z-index: 0; text-align:center;">
        <img src="<?php echo e($logoBase64); ?>" style="width:70%; opacity:0.06; max-width:800px;">
    </div>
<?php endif; ?>
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/partials/pdf-header.blade.php ENDPATH**/ ?>