...
<head>
    ...
    <title>Aperçu export - <?php echo e($ptype); ?></title>
...
<body>
    ...
    <div class="topbar">
        <div style="width:33%;">
            <a href="/" class="logo">
                <img src="<?php echo e(asset('favicon.png')); ?>" alt="logo">
                <strong style="color:#fff; margin-left:4px;">Registrar</strong>
            </a>
        </div>
        <div class="title">
            <p class="b-title center"><strong><?php echo e($ptype); ?></strong></p>
        </div>
    ...
    <script>
        const ptype = '<?php echo e($ptype); ?>';
        const scale = parseFloat('<?php echo e($scale); ?>');
        const quality = parseFloat('<?php echo e($quality); ?>');
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/preview/print-preview.blade.php ENDPATH**/ ?>