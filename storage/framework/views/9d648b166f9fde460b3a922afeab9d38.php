            ...
            <div class="bg-white rounded-3xl shadow-xl card-hover overflow-hidden border border-gray-100 animate-fade-in-up" style="animation-delay: 0.3s">
                ...
                <div class="p-6 space-y-2">
                    ...
                    <div class="info-item flex justify-between items-center py-4 px-3">
                        ...
                        <span class="font-bold text-gray-900 editable" data-field="mention_id"><?php echo e($student->mention->nom ?? '-'); ?></span>
                    </div>
                    <div class="info-item flex justify-between items-center py-4 px-3">
                    ...
                    <div class="info-item flex justify-between items-center py-4 px-3">
                        ...
                        ?>
                        <span class="font-bold text-gray-900 editable" data-field="statut_interne"><?php echo e($displayStatut); ?></span>
                    </div>

                    <div class="info-item flex justify-between items-center py-4 px-3">
                        <span class="text-gray-600 font-semibold flex items-center"><i class="fas fa-ticket-alt text-blue-600 mr-3"></i>Abonné CAF</span>
                        <span class="font-bold text-gray-900 editable" data-field="abonne_caf"><?php echo e($student->abonne_caf ? 'Oui' : 'Non'); ?></span>
                    </div>
...
.gradient-bg, .section-header {
    ...
    let CURRENT_MENTION_ID = <?php echo e($student->mention_id ?? 'null'); ?>;
