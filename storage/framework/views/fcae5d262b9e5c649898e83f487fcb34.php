            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="text-center lg:text-left">
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="bg-blue-900 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-800 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                            S'inscrire maintenant
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="border-2 border-blue-900 text-blue-900 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-900 hover:text-white transition-all duration-300">
                            Se connecter
                        </a>
                    </div>
                </div>
    ...
    </section><?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/layouts/welcome.blade.php ENDPATH**/ ?>