        ...
        <main class="p-4 md:p-6 lg:p-8">
            ...
            <div class="search-container rounded-2xl p-6 mb-8 text-white">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <a href="<?php echo e(route('superadmin.courses.create')); ?>" class="bg-white text-blue-800 px-6 py-3 rounded-xl hover:bg-blue-50 transition-all duration-300 flex items-center justify-center md:justify-start font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                ...
                <div class="mt-6 flex flex-col md:flex-row gap-4">
                    ...
                    <div class="w-full md:w-64">
                        <select id="mentionFilter" class="w-full rounded-xl px-4 py-3 text-gray-800 focus:ring-2 focus:ring-white/30">
                            ...
                            <?php $__currentLoopData = $mentions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(strtolower($m->nom)); ?>"><?php echo e($m->nom); ?></option>
                    ...
                    <tbody class="divide-y divide-gray-100" id="courseTableBody">
                        <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="cursor-pointer course-card hover:bg-blue-50/50 transition-all duration-300" 
                                ...
                                data-yearlevels="<?php echo e(strtolower($course->yearLevels->pluck('label')->join(', '))); ?>"
                                onclick="window.location='<?php echo e(route('superadmin.courses.show', $course->id)); ?>'"> 
                                <td class="px-6 py-5">
                                ...
                                <td class="px-6 py-5">
                                    <?php if($course->yearLevels && $course->yearLevels->count()): ?>
                                        <div class="flex flex-wrap gap-2">
                                            <?php $__currentLoopData = $course->yearLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800"><?php echo e($yl->label); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    <?php else: ?>
                                        <span class="text-gray-400 text-sm">-</span>
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center space-x-3">
                                        <a href="<?php echo e(route('superadmin.courses.edit', $course->id)); ?>" 
                                        ...
                                        <form action="<?php echo e(route('superadmin.courses.destroy', $course->id)); ?>" method="POST" 
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/superadmin/courses/list.blade.php ENDPATH**/ ?>