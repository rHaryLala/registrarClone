...
<head>
    ...
    <title>Fiche de présence - <?php echo e(optional($mention)->nom ?? 'Liste étudiants'); ?></title>
    <style>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <?php $__currentLoopData = $dateHeaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <th class="center nowrap date-col" style="width:2.2%"><?php echo e($dh); ?></th>
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/PDFexport/attendance-sheet.blade.php ENDPATH**/ ?>