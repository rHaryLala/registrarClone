    ...
    <div class="main-content min-h-screen">
        ...
        <main class="p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('dean.teachers.create')); ?>" class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800 transition flex items-center">
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/dean/teachers/list.blade.php ENDPATH**/ ?>