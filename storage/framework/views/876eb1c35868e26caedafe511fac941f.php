...
<head>
    ...
    <title>Cours de <?php echo e($student->prenom); ?> <?php echo e($student->nom); ?> - Université Adventiste Zurcher</title>
        ...
        <main class="p-6 max-w-6xl mx-auto">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 relative z-10">
                    <div class="animate-slide-in-left">
                        <h1 class="text-3xl md:text-4xl font-bold text-white mb-2 font-['Work_Sans']">
                            Cours de <?php echo e($student->prenom); ?> <?php echo e($student->nom); ?>
                        ...
                        <div class="mt-3 flex items-center space-x-3">
                            <span class="inline-flex items-center bg-white/20 text-white px-3 py-1 rounded-lg text-sm font-medium">
                                ...
                                Cours pris: <strong class="ml-2"><?php echo e($takenCount); ?></strong>
                            </span>
                            <span class="inline-flex items-center bg-white/20 text-white px-3 py-1 rounded-lg text-sm font-medium">
                                <i class="fas fa-coins mr-2"></i>
                                Total crédits: <strong class="ml-2"><?php echo e($takenCredits); ?></strong>
                            </span>
                        </div>
                    </div>
                    
                    <div class="animate-slide-in-right flex items-center space-x-3">    
                        <a href="<?php echo e(route('dean.students.courses.add', $student->id)); ?>" 
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden animate-fade-in-up">
                ...
                <div class="hidden md:block overflow-x-auto">
                    <table class="min-w-full table-fixed">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $student->courses()->withPivot('added_at', 'created_at', 'deleted_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-blue-50/50 transition-all duration-300 transform hover:scale-[1.01] animate-fade-in-row <?php if($course->pivot->deleted_at): ?> bg-red-50/80 <?php endif; ?>" 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-sm mr-3 shadow-lg">
                                                <?php echo e(substr($course->sigle, 0, 2)); ?>

                                            </div>
                                            <span class="text-sm font-semibold text-gray-900 font-['Open_Sans']"><?php echo e($course->sigle); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-medium text-gray-900 font-['Open_Sans']"><?php echo e($course->nom); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-600 font-['Open_Sans']">
                                            <?php echo e($course->pivot->added_at ? \Carbon\Carbon::parse($course->pivot->added_at)->format('d/m/Y H:i') : '-'); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-600 font-['Open_Sans']">
                                            <?php if($course->pivot->deleted_at): ?>
                                                <?php echo e(\Carbon\Carbon::parse($course->pivot->deleted_at)->format('d/m/Y H:i')); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if(!$course->pivot->deleted_at): ?>
                                            <form action="<?php echo e(route('dean.students.courses.remove', [$student->id, $course->id])); ?>" method="POST" 
                ...
                <div class="md:hidden p-4 space-y-4">
                    <?php $__currentLoopData = $student->courses()->withPivot('added_at', 'created_at', 'deleted_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-4 transform hover:scale-[1.02] transition-all duration-300 animate-fade-in-up <?php if($course->pivot->deleted_at): ?> bg-red-50 border-red-200 <?php endif; ?>"
                            style="animation-delay: <?php echo e($index * 0.1); ?>s">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900 font-['Work_Sans']"><?php echo e($course->sigle); ?></h3>
                                        <p class="text-sm text-gray-600 font-['Open_Sans']"><?php echo e($course->nom); ?></p>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/dean/students/courses-history.blade.php ENDPATH**/ ?>