    ...
    <div class="flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <h1 class="text-xl font-semibold text-gray-900 hidden sm:block">Tableau de bord | Réseau social</h1>
                <h1 class="text-lg font-semibold text-gray-900 sm:hidden">Socila Media</h1>
            </div>
        </div>
...
<?php /**PATH D:\PROJET REGISTRAIRE\registrarClone\registrar\resources\views/multimedia/components/header.blade.php ENDPATH**/ ?>