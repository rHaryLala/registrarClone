    ...
    <div class="main-content min-h-screen relative z-10">
        ...
        <main class="p-6 max-w-6xl mx-auto">
                    ...
                    <div class="info-item">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="font-semibold text-gray-800 font-['Work_Sans']"><?php echo e($course->sigle); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="font-semibold text-gray-800 font-['Work_Sans']"><?php echo e($course->nom); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="font-semibold text-gray-800 font-['Work_Sans']"><?php echo e($course->credits); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="font-semibold text-gray-800 font-['Work_Sans']"><?php echo e($course->teacher->name ?? 'Non attribué'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="glass-card rounded-2xl p-8 fade-in fade-in-delay-2">
                ...
                <?php if($course->students && count($course->students)): ?>
                    <!-- Desktop Table -->
                    <div class="hidden md:block overflow-hidden rounded-xl border border-gray-200">
                        <table class="min-w-full">
                            ...
                            <tbody class="bg-white">
                                <?php $__currentLoopData = $course->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="table-row border-b border-gray-100 fade-in" style="animation-delay: <?php echo e(0.3 + ($index * 0.1)); ?>s">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap font-['Open_Sans'] text-gray-700">
                                            <?php echo e($student->nom); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap font-['Open_Sans'] text-gray-700">
                                            <?php echo e($student->prenom); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap font-['Open_Sans'] text-blue-600">
                                            <a href="mailto:<?php echo e($student->email); ?>" class="hover:underline">
                    ...
                    <div class="md:hidden space-y-4">
                        <?php $__currentLoopData = $course->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 fade-in" style="animation-delay: <?php echo e(0.3 + ($index * 0.1)); ?>s">
                                <div class="flex items-center mb-4">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-800 font-['Work_Sans']"><?php echo e($student->prenom); ?> <?php echo e($student->nom); ?></h3>
                                        <p class="text-sm text-gray-500 font-['Open_Sans']"><?php echo e($student->matricule); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center text-blue-600">
                                    <i class="fas fa-envelope mr-2"></i>
                                    <a href="mailto:<?php echo e($student->email); ?>" class="hover:underline font-['Open_Sans']">
                                        <?php echo e($student->email); ?>
