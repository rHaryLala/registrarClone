            ...
            <div class="search-container rounded-2xl p-6 mb-8 text-white">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('superadmin.users.create') }}" class="bg-white text-blue-800 px-6 py-3 rounded-xl hover:bg-blue-50 transition-all duration-300 flex items-center justify-center md:justify-start font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                            <i class="fas fa-plus mr-2"></i> Nouvel utilisateur
                        </a>
                        <a href="{{ route('superadmin.users.export_pdf') }}" target="_blank" class="bg-white/80 text-red-700 px-5 py-3 rounded-xl hover:bg-white transition-all duration-300 flex items-center justify-center font-semibold shadow-sm hover:shadow-md">
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-100" id="userTableBody">
                        @forelse($users as $user)
                            <tr class="user-card hover:bg-blue-50/50 transition-all duration-300" data-name="{{ strtolower($user->name) }}" data-email="{{ strtolower($user->email) }}" data-role="{{ strtolower($user->role) }}">
                                <td class="px-6 py-5">
            ...
            <div class="mobile-cards space-y-4" id="mobileUserCards">
                @forelse($users as $user)
                    <div class="user-card bg-white rounded-2xl p-6 shadow-lg border border-gray-100" 
                         data-name="{{ strtolower($user->name) }}" data-email="{{ strtolower($user->email) }}" data-role="{{ strtolower($user->role) }}">
