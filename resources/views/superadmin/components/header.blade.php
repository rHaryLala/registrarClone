    ...
    <div class="flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <h1 class="text-xl font-semibold text-gray-900 hidden sm:block">Tableau de bord SuperAdmin</h1>
                ...
                <div id="userDropdown" class="hidden absolute right-0 mt-2 w-90 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
                    <div class="p-4 border-b border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900">{{ auth()->user()->name ?? 'Admin' }}</p>
                                <p class="text-xs text-gray-500">{{ auth()->user()->email ?? 'registraroffice@zurcher.edu.mg' }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="py-2">
