    ...
    <div class="main-content min-h-screen">
        ...
        <main class="p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('superadmin.users.create') }}" class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800 transition flex items-center">
                        ...
                        @forelse($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap flex space-x-2">
                                    <a href="{{ route('superadmin.users.edit', $user->id) }}" class="text-blue-600 hover:underline flex items-center">
                                        <i class="fas fa-edit mr-1"></i> Modifier
                                    </a>
                                    <form action="{{ route('superadmin.users.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet utilisateur ?');">
                                        @csrf
                                        @method('DELETE')
