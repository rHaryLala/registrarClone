...
<head>
    ...
    <title>Ajouter un utilisateur - Université Adventiste Zurcher</title>
            ...
            <div class="bg-white shadow rounded-lg p-8">
                <form action="{{ route('superadmin.users.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="role" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    <div class="mb-6">
                        <label class="block text-gray-700 font-semibold mb-2">Mot de passe</label>
                        <input type="password" name="password" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
