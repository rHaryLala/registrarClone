            ...
            <div class="bg-white shadow rounded-lg p-8">
                <form action="{{ route('superadmin.settings.update') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" value="{{ old('email', auth()->user()->email) }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="notif_email" value="1" class="mr-2" @if(auth()->user()->notif_email) checked @endif>
                                Email
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="notif_sms" value="1" class="mr-2" @if(auth()->user()->notif_sms) checked @endif>
                                SMS
                            </label>
                        </div>
                    </div>
