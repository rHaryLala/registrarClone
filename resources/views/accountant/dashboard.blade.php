                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div class="md:col-span-2 flex items-center justify-end">
                                            <div class="bg-white rounded-lg px-4 py-2 shadow-sm border border-slate-200">
                                                ...
                                                <span class="font-semibold text-slate-800 ml-2">{{ count($students ?? []) }}</span>
                                            </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-semibold text-sm mr-3">
                                                    {{ substr($student->nom ?? 'N', 0, 1) }}{{ substr($student->prenom ?? 'A', 0, 1) }}
                                                </div>
                                                <span class="text-sm font-medium text-slate-800">{{ $student->matricule ?? '-' }}</span>
                                            </div>
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-sm text-slate-600 font-mono bg-slate-50 px-2 py-1 rounded">{{ $student->account_code ?? '-' }}</span>
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-sm font-medium text-slate-800">{{ $student->nom }}</span>
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-sm text-slate-600">{{ $student->prenom }}</span>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center space-x-3">
                                                <input 
                                                    ...
                                                    data-student-name="{{ $student->nom }} {{ $student->prenom }}"
                                                    {{ $student->fee_check ? 'checked' : '' }}
                                                />
                                                @if($student->fee_check)
